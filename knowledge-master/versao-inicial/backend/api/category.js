module.exports = app => {
    ...
    const remove = async (req, res) => {
        try {
            ...
            notExistsOrError(articles, 'Esta Categoria possui artigos relacionados');
    ...
    const getById = async (req, res) => {
        try {
            const notFoundId = await app.db('categories').where({ id: req.params.id})
            existsOrError(notFoundId, `Categoria não foi encontrada`)
